  ...
  )
{
  ...
  DEBUG ((DEBUG_INFO, "InitializeSmmGenericIpmi entry\n"));
  ...
  // Self-test result since SMM IF may have different cmds supported.
  //
  ...
  Handle = NULL;
  DEBUG ((DEBUG_INFO, "[IPMI] Installing SMM protocol!\n"));
